...
$(function(){
	$("#cancle").click(function(){
		location.href = YMLib.url + 'page/gis/page/qhjc/hddqjc.jsp?hdcode='+getQuery("hdcode");
	});
	
	var params = "reportlet=hmglyh/qhjc/涵洞定期检查.cpt&op=write&hdcode="+getQuery("hdcode")+"&hddqjcid="+getQuery("hddqjcid");
