...
$(function(){
	$("#cancle").click(function(){
		location.href = YMLib.url + 'page/gis/page/qhjc/qljcxjc.jsp?qlcode='+getQuery("qlcode");
	});
	
	var params = "reportlet=hmglyh/qhjc/桥梁经常性检查.cpt&op=write&qlcode="+getQuery("qlcode")+"&qljcxjcid="+getQuery("qljcxjcid");
