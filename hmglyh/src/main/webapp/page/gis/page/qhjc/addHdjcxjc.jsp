...
$(function(){
	$("#cancle").click(function(){
		location.href = YMLib.url + 'page/gis/page/qhjc/hdjcxjc.jsp?hdcode='+getQuery("hdcode");
	});
	
	var params = "reportlet=hmglyh/qhjc/涵洞经常性检查.cpt&op=write&hdcode="+getQuery("hdcode")+"&hdjcxjcid="+getQuery("hdjcxjcid");
