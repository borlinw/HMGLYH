var hdjcxjcColumns = [[
    {title:'操作',rowspan:4,field:'1',formatter:function(value,row,index){
    	return "<a href='javascript:void(0)' onclick=Change('"+row.hdjcxjcid+"')>修改</a>";
    }},
...
var initGrid = function(){
	$("#myGrid").datagrid({
		url : YMLib.url + "qhjc/getHdjcxjc.do",
		border : false,
		fit : true,
		fitColumns : false,
		queryParams : {
...
var initButton = function(){
	$("#add").click(function(){
		if($("#jcrq").val()){
			...
			YMLib.Ajax.POST("qhjc/addHdjcxjc.do",params,"json",function(msg){
				if(msg){
...
var Change = function(_id){
	var params = "hdjcxjcid="+_id+"&hdcode="+getQuery("hdcode");
	location.href = YMLib.url + "page/gis/page/qhjc/addHdjcxjc.jsp?"+params;
};
