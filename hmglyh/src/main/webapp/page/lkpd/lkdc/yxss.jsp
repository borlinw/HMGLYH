...
<script type="text/javascript" src="./js/yxss.js"></script>
...
<body class="easyui-layout">
	<div data-options="region:'north',border:true,split:true" style="height:78px;border-left:0px;border-right:0px;border-top:0px;">
		<!-- <div class="easyui-panel" title="路况评定管理&nbsp;&gt;&nbsp;路况调查&nbsp;&gt;&nbsp;沿线设施" data-options="iconCls:'titleimage',border:false,fit:true" style="padding:8px 0px 0px 10px"> -->
		<div>
			<div class="top_div_lr" >路况评定管理&nbsp;&gt;&nbsp;<font id="lkdcHome" style="cursor:pointer;" >路况调查</font>&nbsp;&gt;&nbsp;沿线设施</div>
