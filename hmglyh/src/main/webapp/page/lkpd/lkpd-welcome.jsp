...
<body style="overflow: hidden; text-align: center; vertical-align: middle; ">
	<table id="table_img" border="0" cellpadding="0" cellspacing="0"><tr><td><img src="${pageContext.request.contextPath}/images/lkpd-welcome.png"  alt=""  /></td></tr></table>
</body>
</html>