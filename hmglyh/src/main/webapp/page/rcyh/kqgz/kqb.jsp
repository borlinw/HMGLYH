...
<script type="text/javascript" src="./js/kqb.js"></script>
...
<body class="easyui-layout">
	<div data-options="region:'north',border:true,split:true" style="height:78px;border-left:0px;border-right:0px;border-top:0px;">
		<div id="righttop">
			<div id="p_top" class="top_div_lr" >&nbsp;当前位置：&nbsp;日常养护管理系统&nbsp;&gt;&nbsp;<font id="kqzgHome" style="cursor:pointer;" >考勤工资</font>&nbsp;&gt;&nbsp;考勤表</div>
		</div>
		<div id="yssj" style='padding-top:4px;padding-left:11px;text-align:left;display: block;'>
			<table>
				<tr>
					...
					<td>
						&nbsp;月份：
						<select id="yf" class="easyui-combobox" panelHeight="400" style="width:200px;"></select>
					</td>
					<td>
						&nbsp;全勤天数：
						<input type="text" id="count" class="easyui-validatebox" data-options="validType:'number'" style="width:70px;"/>
					</td>
					<td>
