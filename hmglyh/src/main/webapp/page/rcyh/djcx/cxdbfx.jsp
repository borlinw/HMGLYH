...
$(function(){
	...
	$.ajax({
		...
		success:function(data){
			...
			$("#reportFrame").attr("src",YMLib.reportUrl+"reportlet=hmglyh%2FNEWcxfydbfx.cpt&bmcodeToChoose="+bmcodeToQuery+"&__bypagesize__=false");
			//$("#reportFrame").attr("src","http://localhost:8075/WebReport/ReportServer?reportlet=hmglyh%2FNEWcxfydbfx.cpt&bmcodeToChoose="+bmcodeToQuery+"&__bypagesize__=false");
		}
	});
});
</script>
...
<body class="easyui-layout">
	...
	<div data-options="region:'center',border:false" style="border-left:0px;border-right:0px;border-button:0px;overflow:hidden;">
		<!-- <iframe id="reportFrame" style="width:100%;height:100%;border:0px" src="/hmglyh/ReportServer?reportlet=hmglyh%2Fcxfyfx2.cpt&op=view" ></iframe> -->
