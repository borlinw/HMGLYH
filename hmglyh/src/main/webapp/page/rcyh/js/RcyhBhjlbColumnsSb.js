 ...
 var BhjlbColumns = [[
    ...
    {field:'aaa',title:'操作',width:200,formatter:function(value,rowData,rowIndex){
    	var returnString = "<a href='javascript:void(0)' onclick=bhxq(\'"+rowData.xcid+"\',\'"+rowData.bhjlid+"\',\'"+rowData.bmcode+"\',\'"+rowData.jlusername+"\') >详情</a>|<a href='/hmglyh/rcyh/bh_updateBh.do?bhjl.bhjlid="+rowData.bhjlid+"&fromSb=true' )>修改</a>|<a href='javasript:void(0)' onclick=delBh(\'"+rowData.bhjlid+"\',\'"+rowData.bhsbzt+"\')>删除</a>";
    	if(rowData.bhsbzt != 2 ){
    ...
    {field:'ldcode',title:'路段',width:100},
