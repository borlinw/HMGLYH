                	      ...
                	      <s:iterator value="resultMap" id="entry" status="status">  
                	        {
                	            ...
                	            radius : radius,
                	            data : [
                	                <s:iterator value="#entry.value" id="jsdj" status="statuss" >
                	              		{name:'<s:property value="#jsdj.name" escape='false' />', value:'<s:property value="#jsdj.value" escape='false' />', itemStyle : label}
