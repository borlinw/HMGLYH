                	      ...
                	      <s:iterator value="resultMap" id="entry" status="status">  
                	        {
                	            ...
                	            radius : radius,
                	            data : [
                	                <s:iterator value="#entry.value" id="lmlx" status="statuss" >
                	              		{name:'<s:property value="#lmlx.name" escape='false' />', value:'<s:property value="#lmlx.value" escape='false' />', itemStyle : label}
